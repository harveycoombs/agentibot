...
class Agent:
    def __init__(self, context: dict, model: str):
        ...
        self.agent = create_agent(
            model=self.model,
            tools=[get_bot_creator, get_server_info, add_role, remove_role, change_nickname, create_text_channel, create_voice_channel, delete_channel, delete_message, ban_member, unban_member, kick_member, bulk_delete_messages],
