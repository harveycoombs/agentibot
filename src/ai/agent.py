...
class Agent:
    def __init__(self, context: dict, model: str):
        ...
        self.agent = create_agent(
            ...
            system_prompt=f"You are Vesper, a helpful assistant that decides which tool is most appropriate to use based on the user's prompt, using both the user's prompt and the following data as parameters for each tool: {json.dumps(self.context)}. You should keep your responses concise."
        )
